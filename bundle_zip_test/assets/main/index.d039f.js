window.__require = function e(t, n, r) {
  ...
  BundleZipScene: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "21d92XIqHtJDp8cRt5Tmck9", "BundleZipScene");
    "use strict";
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.clickBtn = function() {
        var self = this;
        cc.assetManager.loadBundle("bundle_zip", function(err, bundle) {
          bundle.load("" + self._count++ % self._total, cc.SpriteFrame, function(err, sf) {
            self.spt.spriteFrame = sf;
          });
        });
      };
      __decorate([ property(cc.Sprite) ], NewClass.prototype, "spt", void 0);
  ...
  Helloworld: [ function(require, module, exports) {
    ...
    var Helloworld = function(_super) {
      ...
      Helloworld.prototype.clickBundleZip = function() {
        cc.assetManager.loadBundle("bundle_zip", function(err, bundle) {
          bundle && cc.director.loadScene("bundle_zip");
        });
      };
...
}, {}, [ "BundleLoader", "BundleZipScene", "Helloworld" ]);